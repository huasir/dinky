 ...
 */
public class VastbaseTypeConvert extends AbstractJdbcTypeConvert {

    public VastbaseTypeConvert() {
        ...
        register("numeric", VastbaseTypeConvert::convertDecimalOrNumeric);
        register("decimal", VastbaseTypeConvert::convertDecimalOrNumeric);
