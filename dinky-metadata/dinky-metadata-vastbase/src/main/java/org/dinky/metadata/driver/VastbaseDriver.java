...
import org.dinky.metadata.convert.VastbaseTypeConvert;
import org.dinky.metadata.enums.DriverType;
import org.dinky.metadata.query.IDBQuery;
import org.dinky.metadata.query.VastbaseQuery;
 ...
 */
public class VastbaseDriver extends AbstractJdbcDriver {
    ...
    public IDBQuery getDBQuery() {
        return new VastbaseQuery();
    }

    @Override
    public ITypeConvert<AbstractJdbcConfig> getTypeConvert() {
        return new VastbaseTypeConvert();
    }

    @Override
    public String getType() {
        return DriverType.VASTBASE.getValue();
    }
